...
TEMPLATES: dict[str, dict] = {
    ...
    "gambarlabs_report": {
        ...
        "sections": [
            {
                "title": "개요",
                "query": "보고서 개요를 간결하게 작성해주세요. 목적과 주요 활동 요약을 포함합니다. (보고 기간은 별도 필드에 표시되므로 본문에서 제외)",
                "order": 1,
                "match_keywords": ["개요", "목적", "요약"],
            },
            {
                "title": "주요내용",
                "query": "주요 활동 내용을 날짜별로 정리해주세요. 형식: 7월 15일: 활동 내용 (날짜별로 줄바꿈하여 작성)",
                "order": 2,
